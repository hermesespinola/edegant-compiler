...
from keywords import not_ids, arithmetic_ops, relational_ops, boolean_ops, assignment, punctuation
...
initialNode = Node([
    ...
    (set(relational_ops.keys()), terminalNode),
    (set(boolean_ops.keys()), terminalNode),
